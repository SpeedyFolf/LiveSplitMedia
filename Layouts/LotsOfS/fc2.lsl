...
<Layout version="1.6.1">
  ...
  <Settings>
    ...
    <AheadGainingTimeColor>FFCBA777</AheadGainingTimeColor>
    <AheadLosingTimeColor>FF867053</AheadLosingTimeColor>
    <BehindGainingTimeColor>FFD86767</BehindGainingTimeColor>
    <BehindLosingTimeColor>FFB22A2A</BehindLosingTimeColor>
    <BestSegmentColor>FF318789</BestSegmentColor>
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        ...
        <HeaderBottomColor>FF383838</HeaderBottomColor>
    ...
    <Component>
      ...
      <Settings>
        ...
        <AheadGraphColor>FFCBA777</AheadGraphColor>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Users\S-good\Desktop\Nieuwe map (7)\farcry2.asl</ScriptPath>
        <Start>True</Start>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="mainMissions" type="bool">True</Setting>
          <Setting id="act1" type="bool">True</Setting>
          ...
          <Setting id="mission8" type="bool">True</Setting>
          <Setting id="mission9" type="bool">True</Setting>
          <Setting id="mission10" type="bool">True</Setting>
          <Setting id="mission11" type="bool">True</Setting>
          <Setting id="mission12" type="bool">True</Setting>
          <Setting id="mission13" type="bool">True</Setting>
          <Setting id="act2" type="bool">True</Setting>
          <Setting id="mission14" type="bool">True</Setting>
          <Setting id="mission15" type="bool">True</Setting>
          <Setting id="mission16" type="bool">True</Setting>
          <Setting id="mission17" type="bool">True</Setting>
          <Setting id="mission18" type="bool">True</Setting>
          <Setting id="mission19" type="bool">True</Setting>
          <Setting id="mission20" type="bool">True</Setting>
          <Setting id="mission21" type="bool">True</Setting>
          <Setting id="mission22" type="bool">True</Setting>
          <Setting id="mission23" type="bool">True</Setting>
          <Setting id="mission24" type="bool">True</Setting>
          <Setting id="act3" type="bool">True</Setting>
          <Setting id="mission25" type="bool">True</Setting>
          <Setting id="mission26" type="bool">True</Setting>
          <Setting id="mission27" type="bool">True</Setting>
          <Setting id="missionFinal" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
  </Components>
